export default function Zhuyin({ numTonedSyllables }) {
    return (React.createElement(React.Fragment, null, numTonedSyllables.split(/[\s·]+/).map((syllable, i) => {
        ...
        return (React.createElement(React.Fragment, { key: syllable + i },
            i > 0 && React.createElement(React.Fragment, null, "\u00A0"),
            React.createElement("span", { className: `tone${toneNum} ${zhuyinClass}` }, zhuyinMap[syllable.slice(0, -1).toLowerCase()] +
